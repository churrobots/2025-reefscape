...
public class CommandXboxControllerForSimulation extends CommandXboxController {
   ...
   *             plugged into.
   */
  public CommandXboxControllerForSimulation(int port) {
    super(port);
  ...
  public double getRightX() {
    // NOTE: this is an override for simulation compatibility
    // TODO: there are probably other buttons that need to be overridden
    return m_hid.getRawAxis(2);
  }
